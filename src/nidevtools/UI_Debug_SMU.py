...
class UiSMUDebugWindow(object):
    ...
    def setup_ui(self, main_window):
        ...
        self.main_window.resize(1650, 800)
        self.main_window.setMinimumSize(QtCore.QSize(1650, 800))
        self.main_window.setMaximumSize(QtCore.QSize(1650, 800))

        self.central_widget = QtWidgets.QWidget(self.main_window)
        self.central_widget.setObjectName("central_widget")

        self.tab_widget = QtWidgets.QTabWidget(self.central_widget)
        self.tab_widget.setGeometry(QtCore.QRect(10, 110, 1621, 670))
        ...
        self.label_read_timeout.setGeometry(QtCore.QRect(820, 5, 180, 20))
        ...
        self.label_pause_measurements.setGeometry(QtCore.QRect(950, 45, 200, 21))
        ...
        self.label_status.setGeometry(QtCore.QRect(1150, 5, 161, 21))
        font = QtGui.QFont()
        ...
        self.label_pin_status_table.setGeometry(QtCore.QRect(20, 0, 120, 21))
        ...
        self.label_error_messages.setGeometry(QtCore.QRect(20, 520, 200, 40))
        font = QtGui.QFont()
        ...
        self.line_edit_read_timeout.setGeometry(QtCore.QRect(860, 30, 70, 50))
        ...
        self.line_edit_status.setGeometry(QtCore.QRect(1150, 30, 161, 50))
        self.line_edit_status.setObjectName("line_edit_status")

        self.line_edit_error_messages = QtWidgets.QLineEdit(self.tab_table)
        self.line_edit_error_messages.setGeometry(QtCore.QRect(10, 570, 1591, 61))
        ...
        self.push_button_add_remove.setGeometry(QtCore.QRect(190, 30, 200, 50))
        ...
        self.push_button_add_all.setGeometry(QtCore.QRect(400, 30, 100, 50))
        ...
        self.push_button_add_vin.setGeometry(QtCore.QRect(510, 30, 100, 50))
        ...
        self.push_button_custom_list.setGeometry(QtCore.QRect(620, 30, 120, 50))
        ...
        self.push_button_clear_list.setGeometry(QtCore.QRect(750, 30, 100, 50))
        ...
        self.push_button_pause_measurements.setGeometry(QtCore.QRect(970, 70, 140, 41))
        ...
        self.table_widget.setGeometry(QtCore.QRect(10, 40, 1591, 491))
