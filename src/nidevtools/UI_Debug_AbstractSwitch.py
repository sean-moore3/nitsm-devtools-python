...
class UiAbstractSwitchDebugWindow(object):
    ...
    def setup_ui(self, main_window):
        ...
        self.main_window.resize(1133, 694)
        self.main_window.setMinimumSize(QtCore.QSize(1133, 694))
        self.main_window.setMaximumSize(QtCore.QSize(1133, 694))
        self.central_widget = QtWidgets.QWidget(self.main_window)
        self.central_widget.setObjectName("central_widget")

        self.label_new_mux_state = QtWidgets.QLabel(self.central_widget)
        self.label_new_mux_state.setGeometry(QtCore.QRect(160, 0, 100, 40))
        ...
        self.label_update_time.setGeometry(QtCore.QRect(270, 0, 200, 40))
        ...
        self.label_pin_name_filter.setGeometry(QtCore.QRect(480, 0, 150, 40))
        ...
        self.label_view.setGeometry(QtCore.QRect(640, 0, 160, 40))
        ...
        self.label_status.setGeometry(QtCore.QRect(960, 0, 160, 40))
        ...
        self.line_edit_update_time.setGeometry(QtCore.QRect(270, 40, 200, 40))
        ...
        self.line_edit_pin_name_filter.setGeometry(QtCore.QRect(480, 40, 150, 40))
        ...
        self.cb_view.setGeometry(QtCore.QRect(640, 40, 160, 40))
        ...
        self.line_edit_status.setGeometry(QtCore.QRect(960, 40, 160, 40))
        ...
        self.push_button_configure_mux.setGeometry(QtCore.QRect(20, 40, 130, 40))
        ...
        self.push_button_new_mux_state.setGeometry(QtCore.QRect(160, 40, 100, 40))
        ...
        self.push_button_disable_all.setGeometry(QtCore.QRect(810, 40, 140, 40))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 100, 1101, 571))
