...
class UiFPGADebugWindow(object):
    ...
    def setup_ui(self, main_window):
        ...
        self.main_window.resize(760, 616)
        self.main_window.setMinimumSize(QtCore.QSize(760, 616))
        self.main_window.setMaximumSize(QtCore.QSize(760, 616))
        self.central_widget = QtWidgets.QWidget(self.main_window)
        self.central_widget.setObjectName("central_widget")

        self.label_new_state = QtWidgets.QLabel(self.central_widget)
        self.label_new_state.setGeometry(QtCore.QRect(170, 10, 61, 16))
        ...
        self.label_update_time.setGeometry(QtCore.QRect(300, 10, 91, 16))
        ...
        self.label_name_filter.setGeometry(QtCore.QRect(420, 10, 61, 16))
        ...
        self.line_edit_new_state.setGeometry(QtCore.QRect(170, 30, 113, 20))
        ...
        self.line_edit_update_time.setGeometry(QtCore.QRect(300, 30, 113, 20))
        ...
        self.line_edit_name_filter.setGeometry(QtCore.QRect(420, 30, 281, 20))
        ...
        self.push_button_update_command_state.setGeometry(QtCore.QRect(20, 30, 131, 23))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 70, 741, 541))
